...
func (r ApiSubmitFeedbackRequest) SubmitFeedbackRequest(submitFeedbackRequest SubmitFeedbackRequest) ApiSubmitFeedbackRequest {
	r.submitFeedbackRequest = &submitFeedbackRequest
	return r
}

func (r ApiSubmitFeedbackRequest) Execute() (*SubmitFeedbackResponse, *http.Response, error) {
	return r.ApiService.SubmitFeedbackExecute(r)
}

/*
SubmitFeedback Submit feedback for a completion response
...
func (a *FeedbackAPIService) SubmitFeedbackExecute(r ApiSubmitFeedbackRequest) (*SubmitFeedbackResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *SubmitFeedbackResponse
	)
	...
	if r.submitFeedbackRequest == nil {
		return localVarReturnValue, nil, reportError("submitFeedbackRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.submitFeedbackRequest
