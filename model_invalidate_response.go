...
// checks if the InvalidateResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InvalidateResponse{}

// InvalidateResponse struct for InvalidateResponse
type InvalidateResponse struct {
	// Success message
	Message string `json:"message"`
}

type _InvalidateResponse InvalidateResponse

// NewInvalidateResponse instantiates a new InvalidateResponse object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewInvalidateResponse(message string) *InvalidateResponse {
	this := InvalidateResponse{}
	this.Message = message
	return &this
}

// NewInvalidateResponseWithDefaults instantiates a new InvalidateResponse object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewInvalidateResponseWithDefaults() *InvalidateResponse {
	this := InvalidateResponse{}
	return &this
}

// GetMessage returns the Message field value
func (o *InvalidateResponse) GetMessage() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *InvalidateResponse) GetMessageOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *InvalidateResponse) SetMessage(v string) {
	o.Message = v
}

func (o InvalidateResponse) MarshalJSON() ([]byte, error) {
...
func (o InvalidateResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["message"] = o.Message
	return toSerialize, nil
}

func (o *InvalidateResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varInvalidateResponse := _InvalidateResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varInvalidateResponse)

	if err != nil {
		return err
	}

	*o = InvalidateResponse(varInvalidateResponse)

	return err
}

type NullableInvalidateResponse struct {
	value *InvalidateResponse
	isSet bool
}

func (v NullableInvalidateResponse) Get() *InvalidateResponse {
	return v.value
}

func (v *NullableInvalidateResponse) Set(val *InvalidateResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableInvalidateResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableInvalidateResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInvalidateResponse(val *InvalidateResponse) *NullableInvalidateResponse {
	return &NullableInvalidateResponse{value: val, isSet: true}
}

func (v NullableInvalidateResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInvalidateResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
