...
// APIClient manages communication with the Blackman AI API API v0.1.0
...
type APIClient struct {
	...
	SemanticCacheAPI *SemanticCacheAPIService
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.SemanticCacheAPI = (*SemanticCacheAPIService)(&c.common)
