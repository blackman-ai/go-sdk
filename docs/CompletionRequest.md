...
**Metadata** | Pointer to **map[string]interface{}** | Optional metadata for tracking, analytics, and conditional processing. Can include session IDs, user context, feature flags, or any custom data. This metadata is logged with the request and can be used for filtering/analysis. | [optional] 
**Model** | **string** |  | 
...
`func (o *CompletionRequest) SetMetadataNil(b bool)`

 SetMetadataNil sets the value for Metadata to be an explicit nil

### UnsetMetadata
`func (o *CompletionRequest) UnsetMetadata()`
